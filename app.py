...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Hảo - Trường tiểu học Phong Lưu - 0368 683 515</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Hảo - Trường tiểu học Phong Lưu - 0368 683 515</div>", unsafe_allow_html=True)
